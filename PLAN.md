...
## 8. บทเรียนจากเอกสารจริง 5 ใบ (v3 — ปรับจากหน้างานจริง)

วิเคราะห์ตัวอย่างเอกสารจริงของร้าน (ค้าส่ง ย่านสำเพ็ง) พบว่า **มีใบกำกับภาษีเต็มรูปแค่ 1 ใน 5**
ที่เหลือเป็นเอกสารการค้าที่แอปเวอร์ชันแรกไม่รู้จัก:

| พบจริง | ผลกระทบ | การแก้ |
|---|---|---|
| บิลเขียนมือ / ใบเสนอขาย / ใบส่งของชั่วคราว / ใบยืมสินค้า / ใบวางบิล | ประเภทเอกสารไม่พอ | เพิ่ม 5 ประเภทใหม่ใน schema |
| ชื่อร้านเรา (ผู้ซื้อ) เป็นชื่อเดียวที่เขียนบนบิลมือ | AI อาจสลับผู้ซื้อ/ผู้ขาย | ตั้ง "ชื่อร้านของฉัน" ใน Settings แล้วส่งเป็น context ให้ AI ทุกครั้ง |
| ซื้อเครดิต มีวันครบกำหนด + ตรา "จ่ายเงินแล้ว" | ไม่มีระบบติดตามหนี้ | เพิ่มสถานะจ่ายเงิน + วันครบกำหนด + แดชบอร์ดยอดค้างจ่าย |
| เขียนมือแก้ยอดทับเอกสาร (เช่น -2% เงินสด) | ยอดจ่ายจริง ≠ ยอดพิมพ์ | สั่งให้ AI อ่านตัวเขียนมือเป็นการแก้ไขจริง ใช้ยอดสุดท้าย |
| ส่วนลดซ้อน "30+25%" ต่อบรรทัด, ราคา/หน่วยพิมพ์เป็นราคาก่อนลด | ต้นทุนต่อหน่วยเพี้ยน | ใช้ต้นทุนจริง = จำนวนเงิน ÷ จำนวน แทนราคาที่พิมพ์ |
| ส่วนลดเงินสด 5% บนยอดรวม VAT (ราคา VAT-included) | ตัวตรวจสมการเตือนผิด | เพิ่มเคสตรวจ: ผลรวมรายการ − ส่วนลด ≈ ยอดสุทธิ |
| สินค้าเดียวกันคนละหน่วย (ลัง/สำรับ) | ค่าเฉลี่ยต้นทุนมั่ว | รวมกลุ่มสินค้าด้วย ชื่อ+หน่วย |
| ใบชั่วคราวจะมีใบกำกับภาษีจริงตามมา | บันทึกซ้ำ 2 รอบ | เตือนเอกสารเกี่ยวเนื่อง: ผู้ขาย+ยอดเท่ากันในช่วง 45 วัน |
| ปี พ.ศ. 2 หลัก (69) และ ค.ศ. 4 หลัก (2026) ปนกัน | วันที่แปลงผิด | กติกาวันที่ละเอียดขึ้นใน prompt |

## 9. ไอเดียต่อยอด (Phase ถัดไป)
